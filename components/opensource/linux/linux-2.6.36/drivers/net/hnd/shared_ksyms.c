...
extern void bcm_robo_check_gphy_reset; EXPORT_SYMBOL(bcm_robo_check_gphy_reset);
...
extern void bcm_robo_gphy_config; EXPORT_SYMBOL(bcm_robo_gphy_config);
extern void bcm_robo_gphy_misc_wreg; EXPORT_SYMBOL(bcm_robo_gphy_misc_wreg);
