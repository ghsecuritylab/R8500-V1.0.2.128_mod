/* Generated from /opt/r8500/ap/gpl/samba4/samba-4.4.3/source4/heimdal/lib/hdb/hdb.asn1 */
/* Do not edit */
...
HDB-extension ::= SEQUENCE {
  ...
  data            [1] CHOICE {
    ...
    hist-kvno-diff-clnt      [10] INTEGER (0..2147483647),
    hist-kvno-diff-svc       [11] INTEGER (0..2147483647),
