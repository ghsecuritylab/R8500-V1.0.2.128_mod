...
#define NDR_WINBIND_SAMLOGON (0x15)

#define NDR_WINBIND_DSRUPDATEREADONLYSERVERDNSRECORDS (0x16)

#define NDR_WINBIND_LOGONCONTROL (0x17)

#define NDR_WINBIND_GETFORESTTRUSTINFORMATION (0x18)
