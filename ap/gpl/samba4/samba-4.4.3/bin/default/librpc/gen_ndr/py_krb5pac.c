...
static PyGetSetDef py_PAC_LOGON_NAME_getsetters[] = {
	{
		...
		.doc = discard_const_p(char, "PIDL-generated element logon_time")
	},
	{
...
{
	struct PAC_LOGON_INFO *object = (struct PAC_LOGON_INFO *)pytalloc_get_ptr(py_obj);
	talloc_unlink(pytalloc_get_mem_ctx(py_obj), discard_const(object->res_group_dom_sid));
	if (value == Py_None) {
...
static PyGetSetDef py_PAC_LOGON_INFO_getsetters[] = {
	{
		...
		.doc = discard_const_p(char, "PIDL-generated element info3")
	},
	{
		.name = discard_const_p(char, "res_group_dom_sid"),
		.get = py_PAC_LOGON_INFO_get_res_group_dom_sid,
		.set = py_PAC_LOGON_INFO_set_res_group_dom_sid,
		.doc = discard_const_p(char, "PIDL-generated element res_group_dom_sid")
	},
	{
		.name = discard_const_p(char, "res_groups"),
		.get = py_PAC_LOGON_INFO_get_res_groups,
		.set = py_PAC_LOGON_INFO_set_res_groups,
		.doc = discard_const_p(char, "PIDL-generated element res_groups")
	},
	{ .name = NULL }
};
...
static PyGetSetDef py_PAC_CONSTRAINED_DELEGATION_getsetters[] = {
	{
		...
		.doc = discard_const_p(char, "PIDL-generated element proxy_target")
	},
	{
		...
		.doc = discard_const_p(char, "PIDL-generated element num_transited_services")
	},
	{
		...
		.doc = discard_const_p(char, "PIDL-generated element transited_services")
	},
	{ .name = NULL }
};
...
static PyObject *py_PAC_UNKNOWN_12_get_upn_size(PyObject *obj, void *closure)
{
	...
	py_upn_size = PyInt_FromLong((uint16_t)object->upn_size);
	return py_upn_size;
}
...
static int py_PAC_UNKNOWN_12_set_upn_size(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	{
		const unsigned long long uint_max = ndr_sizeof2uintmax(sizeof(object->upn_size));
		if (PyLong_Check(value)) {
			unsigned long long test_var;
			test_var = PyLong_AsUnsignedLongLong(value);
			if (PyErr_Occurred() != NULL) {
...
static PyObject *py_PAC_UNKNOWN_12_get_upn_offset(PyObject *obj, void *closure)
{
	...
	py_upn_offset = PyInt_FromLong((uint16_t)object->upn_offset);
...
static int py_PAC_UNKNOWN_12_set_upn_offset(PyObject *py_obj, PyObject *value, void *closure)
{
	struct PAC_UNKNOWN_12 *object = (struct PAC_UNKNOWN_12 *)pytalloc_get_ptr(py_obj);
	{
		const unsigned long long uint_max = ndr_sizeof2uintmax(sizeof(object->upn_offset));
		if (PyLong_Check(value)) {
			unsigned long long test_var;
			test_var = PyLong_AsUnsignedLongLong(value);
			if (PyErr_Occurred() != NULL) {
...
static PyObject *py_PAC_UNKNOWN_12_get_domain_size(PyObject *obj, void *closure)
{
	...
	py_domain_size = PyInt_FromLong((uint16_t)object->domain_size);
...
static int py_PAC_UNKNOWN_12_set_domain_size(PyObject *py_obj, PyObject *value, void *closure)
{
	struct PAC_UNKNOWN_12 *object = (struct PAC_UNKNOWN_12 *)pytalloc_get_ptr(py_obj);
	{
		const unsigned long long uint_max = ndr_sizeof2uintmax(sizeof(object->domain_size));
		if (PyLong_Check(value)) {
			unsigned long long test_var;
			test_var = PyLong_AsUnsignedLongLong(value);
			if (PyErr_Occurred() != NULL) {
...
static PyObject *py_PAC_UNKNOWN_12_get_domain_offset(PyObject *obj, void *closure)
{
	...
	py_domain_offset = PyInt_FromLong((uint16_t)object->domain_offset);
...
static int py_PAC_UNKNOWN_12_set_domain_offset(PyObject *py_obj, PyObject *value, void *closure)
{
	struct PAC_UNKNOWN_12 *object = (struct PAC_UNKNOWN_12 *)pytalloc_get_ptr(py_obj);
	{
		const unsigned long long uint_max = ndr_sizeof2uintmax(sizeof(object->domain_offset));
		if (PyLong_Check(value)) {
			unsigned long long test_var;
			test_var = PyLong_AsUnsignedLongLong(value);
			if (PyErr_Occurred() != NULL) {
...
static PyObject *py_PAC_UNKNOWN_12_get_unknown4(PyObject *obj, void *closure)
{
	...
	py_unknown4 = PyInt_FromLong((uint16_t)object->unknown4);
	return py_unknown4;
}
...
static PyObject *py_PAC_UNKNOWN_12_get_unknown5(PyObject *obj, void *closure)
{
	...
	py_unknown5 = ndr_PyLong_FromUnsignedLongLong((uint32_t)object->unknown5);
	return py_unknown5;
}
...
static PyObject *py_PAC_UNKNOWN_12_get_unknown6(PyObject *obj, void *closure)
{
	...
	py_unknown6 = ndr_PyLong_FromUnsignedLongLong((uint32_t)object->unknown6);
	return py_unknown6;
}
...
static PyGetSetDef py_PAC_UNKNOWN_12_getsetters[] = {
	{
		.name = discard_const_p(char, "upn_size"),
		.get = py_PAC_UNKNOWN_12_get_upn_size,
		.set = py_PAC_UNKNOWN_12_set_upn_size,
		.doc = discard_const_p(char, "PIDL-generated element upn_size")
	},
	{
		.name = discard_const_p(char, "upn_offset"),
		.get = py_PAC_UNKNOWN_12_get_upn_offset,
		.set = py_PAC_UNKNOWN_12_set_upn_offset,
		.doc = discard_const_p(char, "PIDL-generated element upn_offset")
	},
	{
		.name = discard_const_p(char, "domain_size"),
		.get = py_PAC_UNKNOWN_12_get_domain_size,
		.set = py_PAC_UNKNOWN_12_set_domain_size,
		.doc = discard_const_p(char, "PIDL-generated element domain_size")
	},
	{
		.name = discard_const_p(char, "domain_offset"),
		.get = py_PAC_UNKNOWN_12_get_domain_offset,
		.set = py_PAC_UNKNOWN_12_set_domain_offset,
		.doc = discard_const_p(char, "PIDL-generated element domain_offset")
	},
	{
		.name = discard_const_p(char, "unknown3"),
		.get = py_PAC_UNKNOWN_12_get_unknown3,
		.set = py_PAC_UNKNOWN_12_set_unknown3,
		.doc = discard_const_p(char, "PIDL-generated element unknown3")
	},
	{
		.name = discard_const_p(char, "unknown4"),
		.get = py_PAC_UNKNOWN_12_get_unknown4,
		.set = py_PAC_UNKNOWN_12_set_unknown4,
		.doc = discard_const_p(char, "PIDL-generated element unknown4")
	},
	{
		.name = discard_const_p(char, "unknown5"),
		.get = py_PAC_UNKNOWN_12_get_unknown5,
		.set = py_PAC_UNKNOWN_12_set_unknown5,
		.doc = discard_const_p(char, "PIDL-generated element unknown5")
	},
	{
		.name = discard_const_p(char, "upn_name"),
		.get = py_PAC_UNKNOWN_12_get_upn_name,
		.set = py_PAC_UNKNOWN_12_set_upn_name,
		.doc = discard_const_p(char, "PIDL-generated element upn_name")
	},
	{
		.name = discard_const_p(char, "domain_name"),
		.get = py_PAC_UNKNOWN_12_get_domain_name,
		.set = py_PAC_UNKNOWN_12_set_domain_name,
		.doc = discard_const_p(char, "PIDL-generated element domain_name")
	},
	{
		.name = discard_const_p(char, "unknown6"),
		.get = py_PAC_UNKNOWN_12_get_unknown6,
		.set = py_PAC_UNKNOWN_12_set_unknown6,
...
static PyGetSetDef py_PAC_BUFFER_getsetters[] = {
	...
	},
	{
		...
		.doc = discard_const_p(char, "PIDL-generated element _ndr_size")
	},
	{
		.name = discard_const_p(char, "info"),
...
static PyGetSetDef py_PAC_DATA_getsetters[] = {
	{
		...
		.doc = discard_const_p(char, "PIDL-generated element num_buffers")
	},
	{
...
static PyGetSetDef py_PAC_BUFFER_RAW_getsetters[] = {
	...
	},
	{
		...
		.doc = discard_const_p(char, "PIDL-generated element ndr_size")
	},
	{
		.name = discard_const_p(char, "info"),
...
static PyGetSetDef py_PAC_Validate_getsetters[] = {
	...
	},
	{
		...
		.doc = discard_const_p(char, "PIDL-generated element ChecksumAndSignature")
	},
	{ .name = NULL }
};
...
void initkrb5pac(void)
{
	...
	PAC_UNKNOWN_12_Type.tp_base = BaseObject_Type;
	PAC_UNKNOWN_12_Type.tp_basicsize = pytalloc_BaseObject_size();
	...
	PyModule_AddObject(m, "PAC_TYPE_UNKNOWN_12", ndr_PyLong_FromUnsignedLongLong((uint32_t)PAC_TYPE_UNKNOWN_12));
