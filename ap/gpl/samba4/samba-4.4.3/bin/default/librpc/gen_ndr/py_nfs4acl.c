...
static PyObject *syntax_nfs4acl_new(PyTypeObject *type, PyObject *args, PyObject *kwargs)
{
	return py_dcerpc_syntax_init_helper(type, args, kwargs, &ndr_table_nfs4acl.syntax_id);
}

static PyTypeObject nfs4acl_SyntaxType = {
	PyObject_HEAD_INIT(NULL) 0,
	.tp_name = "nfs4acl.nfs4acl",
	.tp_doc = "abstract_syntax()\n",
	.tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
	.tp_new = syntax_nfs4acl_new,
};
...
void initnfs4acl(void)
{
	...
	nfs4acl_SyntaxType.tp_base = ndr_syntax_id_Type;
	nfs4acl_SyntaxType.tp_basicsize = pytalloc_BaseObject_size();
	...
	if (PyType_Ready(&nfs4acl_InterfaceType) < 0)
		return;
	if (PyType_Ready(&nfs4acl_SyntaxType) < 0)
		return;
	...
	PY_ABSTRACT_SYNTAX_PATCH(&nfs4acl_SyntaxType);
#endif
	...
	Py_INCREF((PyObject *)(void *)&nfs4acl_SyntaxType);
	PyModule_AddObject(m, "abstract_syntax", (PyObject *)(void *)&nfs4acl_SyntaxType);
