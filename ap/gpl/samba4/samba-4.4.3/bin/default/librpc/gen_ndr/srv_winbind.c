...
static bool api_wbint_Uid2Sid(struct pipes_struct *p)
{
	...
	call = &ndr_table_winbind.calls[NDR_WBINT_UID2SID];
...
static bool api_wbint_Gid2Sid(struct pipes_struct *p)
{
	...
	call = &ndr_table_winbind.calls[NDR_WBINT_GID2SID];
...
static bool api_wbint_QueryUser(struct pipes_struct *p)
{
	...
	call = &ndr_table_winbind.calls[NDR_WBINT_QUERYUSER];
...
static bool api_wbint_QueryUserList(struct pipes_struct *p)
{
	...
	call = &ndr_table_winbind.calls[NDR_WBINT_QUERYUSERLIST];
...
/* Tables */
static struct api_struct api_winbind_cmds[] = 
{
