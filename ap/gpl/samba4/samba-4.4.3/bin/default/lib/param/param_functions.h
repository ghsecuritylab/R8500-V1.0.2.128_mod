...
bool lpcfg_only_user(struct loadparm_service *, struct loadparm_service *);
...
char *lpcfg_username(struct loadparm_service *, struct loadparm_service *, TALLOC_CTX *ctx);
