...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-shared --enable-gpl --arch=arm --cc=arm-brcm-linux-uclibcgnueabi-gcc --enable-cross-compile --disable-muxers --disable-encoders --disable-filters --arch=arm --target_os=linux --extra-cflags=-fPIC
prefix=/usr/local
...
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=arm-brcm-linux-uclibcgnueabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=ar
...
DLLTOOL=
WINDRES=windres
DEPWINDRES=arm-brcm-linux-uclibcgnueabi-gcc
DOXYGEN=doxygen
...
avdevice_FFLIBS=avfilter avformat avcodec swresample avutil
