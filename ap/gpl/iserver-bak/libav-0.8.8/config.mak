...
LIBAV_CONFIGURATION=--prefix=/usr --arch=arm --target-os=linux --cc=arm-brcm-linux-uclibcgnueabi-gcc --enable-cross-compile --disable-static --enable-shared
prefix=/usr
...
SRC_PATH=.
CC_IDENT=gcc 4.5.3 (Buildroot 2012.02)
ARCH=arm
...
ACODEC_TESTS=ac3_fixed adpcm_adx adpcm_ima_qt adpcm_ima_wav adpcm_ms adpcm_swf adpcm_yam alac aref flac g722 g726 mp2 pcm_alaw pcm_f32be pcm_f32le pcm_f64be pcm_f64le pcm_mulaw pcm_s16be pcm_s16le pcm_s24be pcm_s24daud pcm_s24le pcm_s32be pcm_s32le pcm_s8 pcm_u8 wmav1 wmav2 
VCODEC_TESTS=asv1 asv2 cljr dnxhd_1080i dnxhd_720p dnxhd_720p_10bit dnxhd_720p_rd dv dv50 dv_411 error ffv1 flashsv flv h261 h263 h263p huffyuv jpegls ljpeg mjpeg mpeg mpeg1b mpeg2 mpeg2_422 mpeg2_idct_int mpeg2_ilace mpeg2_ivlc_qprd mpeg2thread mpeg2thread_ilace mpeg4 mpeg4_adap mpeg4_qpel mpeg4_qprd mpeg4adv mpeg4nr mpeg4thread msmpeg4 msmpeg4v2 qtrle rc rgb roq rv10 rv20 snow snowll svq1 v210 vref wmv1 wmv2 yuv 
