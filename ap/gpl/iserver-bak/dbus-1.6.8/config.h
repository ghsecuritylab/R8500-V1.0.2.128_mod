...
#define DBUS_TEST_EXEC "/opt/r8500/ap/gpl/iserver/dbus-1.6.8/test"

/* Full path to the launch helper test program in the builddir */
#define DBUS_TEST_LAUNCH_HELPER_BINARY "/opt/r8500/ap/gpl/iserver/dbus-1.6.8/bus/dbus-daemon-launch-helper-test"
...
/* Full path to the daemon in the builddir */
#define TEST_BUS_BINARY "/opt/r8500/ap/gpl/iserver/dbus-1.6.8/bus/dbus-daemon"
